...
const getAllTeachers = () => {
  return db.query(
    "select " +
      "u.idusers, u.name, u.last_name, u.image, t.description_prof, t.description_class, t.title_prof, ths.hourly_rate, ths.free_classl, ths.level, t.experience, r.rate, u.role, u.province_idprovince, s.idsubjects " +
      "from  users as u " +
      "left join province as p on p.idprovince=u.province_idprovince " +
      "left join teachers as t on t.users_idusers=u.idusers " +
